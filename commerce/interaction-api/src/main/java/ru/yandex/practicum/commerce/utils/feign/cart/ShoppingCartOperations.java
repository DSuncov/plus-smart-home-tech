...
public interface ShoppingCartOperations {
    ...
    @PutMapping
    ResponseEntity<ShoppingCartDto> addProductToShoppingCart(@RequestParam String username, @RequestBody @Valid @NotNull Map<UUID, Long> products)
    ...
    @PostMapping("/remove")
    ResponseEntity<ShoppingCartDto> removeProductsFromShoppingCart(@RequestParam @NotBlank String username, @NotEmpty List<UUID> ids)
            throws NotAuthorizedUserException;
