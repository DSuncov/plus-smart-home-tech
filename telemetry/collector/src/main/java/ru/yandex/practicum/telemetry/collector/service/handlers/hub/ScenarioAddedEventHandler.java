...
public class ScenarioAddedEventHandler implements BaseHubEventHandler {
    ...
    private ScenarioConditionAvro getScenarioConditionAvro(ScenarioConditionProto s) {
        ...
        switch (s.getValueCase()) {
            case INT_VALUE -> scenarioConditionAvro.setValue(s.getIntValue());
            case BOOL_VALUE -> scenarioConditionAvro.setValue(s.getBoolValue());
            default -> scenarioConditionAvro.setValue(null);
        }
